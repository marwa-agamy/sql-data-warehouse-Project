...
LEFT JOIN silver.erp_loc_a101 ce ON ca.cid=ce.cid
...
where prd_end_dt IS NULL --Filter Out All Historical Data --Current Data Only
...
ON sd.sls_prd_key = pr.product_number LEFT JOIN gold.dim_customers cr
